...
class Constants {
    ...
    static URL_API = process.env.NODE_ENV == 'debug' ? 'http://127.0.0.1:3031/' : 'https://dev.api.yourcompany.com/';
    static URL_MEDIA = process.env.NODE_ENV == 'debug' ? 'http://127.0.0.1:3031/' : 'https://dev.api.yourcompany.com/';
